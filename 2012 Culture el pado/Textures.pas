...
//       Modified by Ivan Lipko
// 1. 2012-08-11
//   248 and 251 string are made from
//                For H:=0 to Height-1 do
//               to    --^         --^
//                   For H:=1 to Height-2 do
//                       --^          --^
//    this modification erase bug (artifacts) vertical line from texture.
//    for example she can be white or differ from other texture
...
function LoadTexture(Filename: String; var Texture: GLuint; LoadFromRes : Boolean  = false): Boolean;
